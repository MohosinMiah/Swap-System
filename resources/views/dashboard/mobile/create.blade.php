 ...
 <div id="content">
          ...
          <h2 class="text-center">Mobile Category </h2>
           ...
           <h3 class="text-center">Choose a Variant</h3>
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="ram_rom" name="ram_rom" data-role="tagsinput"   required>
            </div>

            <div class="form-group">
              <label for="sim">SIM *</label>
              <input type="text" class="form-control" id="sim" name="sim" data-role="tagsinput"   required>
            </div>
    ...
    --}}
             <div class="form-group">
               ...
               <input type="text" class="form-control" id="specificationsim" name="specificationsim" data-role="tagsinput"   required>
             </div>

             <div class="form-group">
               <label for="specificationcamera">Camera *</label>
               <input type="text" class="form-control" id="specificationcamera" name="specificationcamera" data-role="tagsinput"   required>
             </div>
 
             <div class="form-group">
               <label for="specificationprocessor">Processor *</label>
               <input type="text" class="form-control" id="specificationprocessor" name="specificationprocessor" data-role="tagsinput"   required>
             </div>
 
             <div class="form-group">
               <label for="specificationbattery">Battery *</label>
               <input type="text" class="form-control" id="specificationbattery" name="specificationbattery" data-role="tagsinput"   required>
             </div>
